...
const CoursesSection = () => {
  ...
  return (  
    <div className="py-16 md:px-40   text-gray-200">
      ...
      <Link to={'/course-list'} onClick={() => scrollTo(0, 0)} className="text-gray-100 border border-gray-500/30 px-10 py-3 rounded bg-green-600 ">Show all courses</Link>
    </div> 
  );
};
