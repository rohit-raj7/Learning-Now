  ...
  return (
    <>
      <div className="container mx-auto px-4 py-8 text-gray-200">
        ...
        <p className="text-sm text-center mb-4"><strong>Last Updated: [01/06/2025]</strong></p>

        <p className="mb-6">
          Welcome to our Education Portal <a href="https://online-learning-iota.vercel.app/">Online Learning</a>. Your privacy and security are very important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you use our platform where teachers can upload educational videos and students can enroll in courses after logging in using Clerk authentication.
        </p>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6">
            <li><strong>Personal Information:</strong> Name, email address, and profile details collected during user registration via Clerk.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6">
            <li>Authenticate and manage your account securely using Clerk.</li>
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc pl-6">
            <li><strong>Clerk:</strong> For user authentication and identity management. Clerk manages login credentials securely and has its own privacy practices.</li>
