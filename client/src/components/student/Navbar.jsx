...
import React, { useContext, useRef, useState, useEffect } from 'react'; // <== add useEffect
    ...
    <div className="bg-[#112d46] border-b border-gray-500 px-4 py-3 flex justify-between items-center">
      ...
      {isUser ? (
        <div className="flex items-center gap-4 text-gray-500 relative">
          ...
          />
       {showProfileDropdown && (
  <div ref={dropdownRef}  className="absolute top-14 right-0 w-64 sm:w-80 z-50 p-5 bg-gray-900 text-gray-100 rounded-xl shadow-xl border border-gray-800">
