...
const Player = ({ }) => {
  ...
  const { enrolledCourses, VITE_BACKEND_URL, getToken, calculateChapterTime, userData, fetchUserEnrolledCourses } = useContext(AppContext)
  ...
  const markLectureAsCompleted = async (lectureId) => {
    ...
    try {
      ...
      const { data } = await axios.post(VITE_BACKEND_URL + '/api/user/update-course-progress',
        { courseId, lectureId },
  ...
  const getCourseProgress = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(VITE_BACKEND_URL + '/api/user/get-course-progress',
        { courseId },
        { headers: { Authorization: `Bearer ${token}` } }
      )
  ...
  const handleRate = async (rating) => {
    ...
    try {
      ...
      const { data } = await axios.post(VITE_BACKEND_URL + '/api/user/add-rating',
        { courseId, rating },
        { headers: { Authorization: `Bearer ${token}` } }
      )
