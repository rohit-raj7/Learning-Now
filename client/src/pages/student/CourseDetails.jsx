...
const CourseDetails = () => {
  ...
  const { VITE_BACKEND_URL, currency, userData, calculateChapterTime, calculateCourseDuration, calculateRating, calculateNoOfLectures } = useContext(AppContext)
  ...
  const enrollCourse = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(VITE_BACKEND_URL + '/api/user/purchase',
  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left bg-gray-800 text-gray-100">
        <div className="absolute top-0 left-0 w-full h-section-height -z-1  text-gray-100 bg-gray-800"></div>

        <div className="max-w-xl z-10 text-gray-100">
          <h1 className="md:text-course-deatails-heading-large text-course-deatails-heading-small font-semibold text-gray-200">
          ...
          <div className="pt-8 text-gray-200 bg-gray-800">
                ...
                <div key={index} className="border border-gray-200 bg-gray-800 mb-2 rounded">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <p className="font-medium md:text-base text-sm text-gray-200">{chapter.chapterTitle}</p>
                    </div>
                    <p className="text-sm md:text-default text-gray-200">{chapter.chapterContent.length} lectures - {calculateChapterTime(chapter)}</p>
                  </div>
        ...
        <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-gray-800 border border-gray-500 min-w-[300px] sm:min-w-[420px]">
          {
            playerData
          ...
          <div className="p-5 bg-gray-800 ">
            ...
            <div className="flex gap-3 items-center pt-2">
              <p className="text-gray-300 md:text-4xl text-2xl font-semibold">{currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice / 100).toFixed(2)}</p>
