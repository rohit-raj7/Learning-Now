...
// import Loading from '../../components/educator/Login-Signup/Loading';
...
//   const [showPopup, setShowPopup] = useState(false);
//   const [currentChapterId, setCurrentChapterId] = useState(null);
//   const [uploadProgress, setUploadProgress] = useState(0);          // ✅ Added
//   const [uploadTimeLeft, setUploadTimeLeft] = useState(0);          // ✅ Added
...
//                         const timeLeft = Math.round((event.total - event.loaded) / speed);
...
//                       if (res.secure_url) {
//                         setLectureDetails((prev) => ({ ...prev, lectureUrl: res.secure_url }));
